...
import img1 from "../assets/storefront.webp";
import img2 from "../assets/product_pageopti.webp";
import img3 from "../assets/payment.webp";
import img4 from "../assets/mobile_responsive.webp";
import img5 from "../assets/analytics.webp";

const carouselSlides = [
  {
    img: img1,
    title: "Custom Storefront Design",
    text: "We design visually engaging and user-friendly storefronts that reflect your brand and drive conversions.",
  },
  {
    img: img2,
    title: "Product Page Optimization",
    text: "Clear layouts, rich media, and smart UX that help your products stand out and sell more effectively.",
  },
  {
    img: img3,
    title: "Secure Payment Integration",
    text: "Seamless and safe checkout experiences with Stripe, PayPal, local gateways, and more.",
  },
  {
    img: img4,
    title: "Mobile-Responsive Shopping",
    text: "Your store will look and work perfectly on every screen — mobile, tablet, and desktop.",
  },
  {
    img: img5,
    title: "Analytics & Performance Tracking",
    text: "Integrated tools to track sales, user behavior, and conversions — helping you make data-driven decisions.",
  },
];
    ...
    <>
      ...
      <section className="webdev-services-section">
        <div className="webdev-services-container">
          <h1 className="webdev-services-title">E-Commerce Services</h1>
          <p className="webdev-services-text">
            Build a secure, high-performing online store designed to convert.
            From sleek product pages to seamless checkout, we deliver custom
            e-commerce solutions that grow your business.
          </p>
          <button className="service_btn" onClick={handleOrderNow}>
            Lets Create a Ecommerce PLatform
          </button>
        </div>
      </section>
      <motion.section
      ...
      <motion.section>
        <section className="why_choose_us">
          <div className="why-choose-container">
            <h2 className="why-choose-title">Why Choose Us for Ecommerce?</h2>
            <p className="why-choose-text">
              Our ecommerce solutions are designed to help you sell more and
              manage your business efficiently. We focus on user experience,
              security, and scalability, ensuring your online store is robust,
              easy to use, and ready to grow with your business.
            </p>
            <ul className="why-choose-list">
              <li>Custom, scalable ecommerce platforms</li>
              <li>Seamless shopping & checkout experience</li>
      ...
      {showFormModal && (
        ...
        >
          ...
          >
            ...
            >
              Fill the form to get started with your e-commerce platform
            </motion.p>
            <form
              ref={formRef}
...
export default Ecommerce_Services;
