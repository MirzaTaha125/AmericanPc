...
import img1 from "../assets/wordpress-cms.webp";
import img2 from "../assets/Landingpage.webp";
import img3 from "../assets/codingwebsite.webp";
import img4 from "../assets/responsive_design.webp";
import img5 from "../assets/seooptimize.webp";

const carouselSlides = [
  {
    img: img1,
    title: "Custom Landing Pages",
    text: "We create tailored websites that drive results for your business.",
  },
  {
    img: img2,
    title: "CMS",
    text: "Launch your online store with seamless shopping experiences.",
  },
  {
    img: img3,
    title: "Performance & Security",
    text: "Fast, secure, and scalable web development for every need.",
  },
  {
    img: img4,
    title: "Responsive Design",
    text: "Your site will look perfect on all devices — mobile, tablet, and desktop.",
  },
  {
    img: img5,
    title: "SEO Optimization",
    text: "Boost your visibility on search engines with smart SEO strategies.",
  },
];
    ...
    <>
      ...
      <section className="webdev-services-section">
        <div className="webdev-services-container">
          <h1 className="webdev-services-title">Web Development Services</h1>
        ...
        <section className="why_choose_us">
          <div className="why-choose-container">
            ...
            <p className="why-choose-text">
              ...
              deliver websites that not only look stunning but also drive
              results. Our team is dedicated to building fast, secure, and
              scalable solutions tailored to your unique needs. With a focus on
              user experience, SEO, and mobile responsiveness, we ensure your
              online presence stands out in a crowded digital landscape.
            </p>
            <ul className="why-choose-list">
              <li>Custom, business-focused solutions</li>
              <li>Modern, responsive design</li>
              <li>SEO & performance optimized</li>
              <li>Dedicated support & maintenance</li>
              <li>Transparent process & communication</li>
            </ul>
          </div>
        </section>
      </motion.section>
      ...
      {showFormModal && (
        ...
        >
          ...
          >
            ...
            >
              Fill the form to get started with your website development project
            </motion.p>
            <form
              ref={formRef}
...
export default WebDevelopment_Services;
