...
import ecommerceImg from "../assets/Website_Portfolio/gmwndtlyvsiqeupvrtvy.webp";

const ECOMMERCE_PACKAGES = PACKAGES.ecommerce;
    ...
    <>
      ...
      <section className="packages-section">
        ...
        >
          ...
          <span className="about-label">Ecommerce Packages</span>
        </div>
        <h2 className="packages-title">Sell Online. Grow Your Business.</h2>
